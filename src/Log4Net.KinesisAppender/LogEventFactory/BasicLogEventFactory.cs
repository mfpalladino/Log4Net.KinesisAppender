...
namespace Log4Net.KinesisAppender.LogEventFactory
{
    public class BasicLogEventFactory : ILogEventFactory
    {
        ...
        public virtual Dictionary<string, object> CreateLogEvent(LoggingEvent loggingEvent, string appName)
        {
            ...
            ParseBasicFields(loggingEvent, appName, resultDictionary);
        ...
        protected void ParseBasicFields(LoggingEvent loggingEvent, string appName, Dictionary<string, object> resultDictionary)
        {
            ...
            resultDictionary["AppName"] = appName;
